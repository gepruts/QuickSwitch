...
;			WinGetClass, _grandparentClass, ahk_id %_grandparentHandle%
		...
		;	Get class of greatgrandparent control
			...
			If InStr( _greatgrandparentClass, "msctls_progress32" )
...
;MsgBox DEBUG _useToolbar = %_useToolbar% `n _EnterToolbar = %_EnterToolbar% `n _addressEdit = %_addressEdit% 
